  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto flex flex-col">
          ...
          <div className="flex items-center gap-3 sm:gap-4 self-start sm:self-auto">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-[var(--border)] bg-[var(--bg-panel)] text-[var(--text-primary)] shadow-sm transition-all duration-150 flex items-center justify-center focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:outline-none ${
                  activeIndex === 0
        ...
        <div className="relative w-full overflow-hidden rounded-[20px] sm:rounded-[24px]">
          <motion.div
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 pt-1 sm:pt-2">
                    ...
                    <div className="flex flex-col gap-4 sm:gap-5 text-left">
                      ...
                      <div>
                        ...
                        <p className="font-sans text-xs sm:text-sm text-[var(--text-body)] leading-relaxed mb-2.5 sm:mb-3">
                          {project.howItWorks}
                        </p>
